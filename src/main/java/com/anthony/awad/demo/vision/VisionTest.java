package com.anthony.awad.demo.vision;
...
public class VisionTest {
	  ...
	  public ResponseEntity<ModelMap> extractLabels(String imageUrl, ModelMap map) {

		  imageUrl = "image_me.jpg";
...
//		  // change to accept file and get new file().path  
		  imageUrl = "image_me.jpg";
